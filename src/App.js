...
function App() {
  ...
  const surnameClickHandler = () => {
    setDisp("Christian Dean Peralta");
  };

  return (
    <div className="App">
      <h1>Calculator of Christian Dean Peralta - IT3A</h1>
      <div className="CalcContainer">
        ...
        <div className="ButtonsContainer">
          ...
          <Key
            label={"="}
            clickHandler={equalsClickHandler}
        ...
        <Key
          label={"PERALTA"}
          clickHandler={surnameClickHandler}
          className="PeraltaButton"
        />
      </div>
    </div>
  );
